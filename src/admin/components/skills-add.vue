<template lang="pug">
    .skill-block.skill-block--new
        .skill-block__upper-row.new(
            ...
            input(type="text" v-model='skillTitle' placeholder="Название новой группы").skill-block__title
            .input__error-tooltip.skillGroup
                errorTooltip(:errorText="validation.firstError('skillTitle')")
            .skill-block__upper-btns
                .skill-block__new-type-btns
                    button(type='button' @click = 'addSkillGroup').btn.btn--save-skill-block
